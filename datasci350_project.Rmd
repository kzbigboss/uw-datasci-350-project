---
title: "UW PCE Data Science 350 - Final Project"
author: "Mark Kazzaz"
date: "June 2, 2016"
output: 
  html_document:
...
# Project Overview
The aim of this project was to perform statistical analysis on NBA data.  I set out to test two hypotheses:

*  Hypothesis One: Box score summary data can be used to classify a win or a loss with 90%+ accuracy.
...
*  Hypothesis Two: Q4 fouls contribute to wins in non-overtime regular season games.
...
The below code snippets are provided to help guide you through my basic methodology for acquiring, transforming, and analyzing the data.  Not all code used is presented in this write up.  

If you're interested in seeing all my code, you can download it [here](https://www.dropbox.com/s/q7reaegp4a8wpbz/nba%20stats.r?dl=1).

# Data acquisition

## NBA.com/Stats website

[NBA.com/Stats](http://stats.nba.com) is a site dedicated to making a variety of NBA stats available to review.  The struggle is they intentionally don't make it available for usage outside of their website.  Per their [FAQ](http://stats.nba.com/help/faq/):
...
In order to test this hypothesis, I needed all the box score summary results for all 30 teams for each of their 82 regular season games.  No way I was going to copy/paste 82 links via Chrome developer tools to figure this out.  Instead, I took the following approach:
...
In order to test this hypothesis, I needed to do a few things:
